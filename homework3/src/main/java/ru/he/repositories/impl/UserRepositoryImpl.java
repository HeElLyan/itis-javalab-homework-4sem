...
public class UserRepositoryImpl implements UserRepository {
    ...
    //language=SQL
    private static final String SQL_UPDATE = "update db_user set email = ?, password = ?, status = ?, confirm_id = ?, role = ? WHERE id = ?";

    //language=SQL
    private static final String SQL_DELETE_BY_ID = "DELETE FROM db_user WHERE id = ?";

    //language=SQL
    private static final String SQL_INSERT = "INSERT INTO db_user(email, password, status, confirm_id, role) VALUES (?, ?, ?, ?, ?)";
